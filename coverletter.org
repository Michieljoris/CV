...
my [[http://github.com/michieljoris][github]] account). I am also a pianist and ran a piano studio in Brisbane for
many years.
...
#+LATEX: \vspace{3mm} %3mm vertical space  
...
- *delimit*: break up in modules, pure/independant functions, not bigger than my head per function, clear global structure/architecture
