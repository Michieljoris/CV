...
\cventry{2015--2020}{Programmer}{DigitaleChecklisten}{Amsterdam,
Netherlands}{}{Startup, offering checklists, but on top of that analytics, and case/process
management{}%
\begin{itemize}%
\item Added features such as search and filter, contact management, user
interface, testing framework to the main app, but also worked on upgrading,
importing data and general bug fixing in both front (Ember) and backend (Rails).
\item Built the accompanying admin app in clojure.
\end{itemize}}
...
\begin{itemize}%
\item Developed two websites which were in production for a few years
...
\begin{itemize}%
\item Built from scratch on nodejs
...
\cvitemwithcomment{Clojure(Script)}{Advanced}{Main language used at work (and for fun) last couple of years}
\cvitemwithcomment{Javascript}{Advanced}{Built full stack framework in it
(2014), Ember was frontend framework at work last couple of years}
\cvitemwithcomment{Ruby}{Intermediate}{Rails was backend framework at work last
couple of years}
\cvitemwithcomment{Lisp}{Intermediate}{Did TEOCS in Common Lisp, Scheme for SICP}
\cvitemwithcomment{Java}{Intermediate}{Not my favorite, but I did do some hobby
projects}
\cvitemwithcomment{C}{Intermediate}{Learned to program in C as a teenager}
\cvitemwithcomment{HTML, CSS, SQL}{Intermediate}{Know what I need}
\cvitemwithcomment{Haskell, Ruby, Coffeescript, Erlang, PHP}{Beginner}{Dabbled and/or read some books on them}
%% \cvitemwithcomment{Language 3}{Skill level}{Comment}

\section{Computer skills}
\cvdoubleitem{Databases}{CouchDB, MySql}{Libs}{React, Ember, Rails}
\cvdoubleitem{Editors}{Emacs, Vim}{CMS}{Drupal, Joomla}
\cvdoubleitem{OS}{Ubuntu, Windows, MacOs}{Other}{Docker,Vagrant}
...
\cvlistitem{Piano, speed skating, cycling, sailing, classical music, literature.}
%% \cvlistitem{Item 2}
